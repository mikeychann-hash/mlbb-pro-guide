...
export const s = {
  ...
  fb: (a, c) => ({ fontFamily: DISPLAY, padding: "5px 12px", fontSize: 11, fontWeight: a ? 700 : 600, background: a ? (c || P.gold) + "22" : "rgba(255,255,255,.035)", color: a ? (c || P.gold) : P.t3, border: `1px solid ${a ? (c || P.gold) + "77" : P.brd}`, borderRadius: 999, cursor: "pointer", letterSpacing: .3 }),

  cd2: { background: "linear-gradient(180deg, rgba(21,31,54,.62), rgba(12,19,34,.62))", border: `1px solid ${P.brd}`, borderRadius: 14, padding: "12px 14px", marginBottom: 8, cursor: "pointer", boxShadow: "0 2px 12px rgba(0,0,0,.28)" },
  bg: (c, fl) => ({ display: "inline-block", padding: "3px 9px", borderRadius: 7, fontSize: 9.5, fontWeight: 700, letterSpacing: .4, background: fl ? c : (c || P.gold) + "1f", color: fl ? "#070707" : c || P.gold, marginRight: 4, border: `1px solid ${fl ? "transparent" : (c || P.gold) + "44"}` }),
  sc: { fontFamily: DISPLAY, fontSize: 14, fontWeight: 800, letterSpacing: .6, color: P.t1, margin: "18px 0 10px", paddingLeft: 10, borderLeft: `3px solid ${P.gold}`, textTransform: "uppercase" },
  tp: { background: `linear-gradient(180deg, ${P.blue}14, ${P.blue}06)`, border: `1px solid ${P.blue}33`, borderRadius: 11, padding: "11px 13px", fontSize: 11.5, color: `${P.blue}ee`, lineHeight: 1.65, marginTop: 10 },
  bk: { fontFamily: DISPLAY, background: "rgba(255,255,255,.035)", border: `1px solid ${P.brd}`, borderRadius: 10, padding: "8px 16px", color: P.t2, fontSize: 12, fontWeight: 700, cursor: "pointer", marginBottom: 12, letterSpacing: .5 },
  ch: c => ({ display: "inline-flex", alignItems: "center", gap: 4, padding: "4px 11px", borderRadius: 999, fontSize: 11, fontWeight: 600, background: c + "18", color: c, border: `1px solid ${c}3a`, marginRight: 4, marginBottom: 4, cursor: "pointer", letterSpacing: .2 }),
